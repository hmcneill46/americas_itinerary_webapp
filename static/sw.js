const CACHE_NAME = 'trip-planner-shell-v7';
const APP_SHELL = [
  '/', '/static/index.html', '/static/styles.css?v=schedule-modes-v4',
  '/static/app.js?v=schedule-modes-v4', '/static/offline-store.js?v=offline-v5',
  '/static/budget.js?v=budget-v5', '/static/booking.js?v=booking-v1',
  '/static/import-diff.js?v=import-v1', '/static/today.js?v=today-v1',
  '/static/timeline.js?v=schedule-modes-v4',
