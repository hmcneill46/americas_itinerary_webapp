const CACHE_NAME = 'trip-planner-shell-v12';
const APP_SHELL = [
  '/', '/static/index.html', '/static/styles.css?v=schema-v9',
  '/static/app.js?v=schema-v9', '/static/offline-store.js?v=offline-v5',
  '/static/budget.js?v=budget-v9', '/static/booking.js?v=booking-v2',
  '/static/import-diff.js?v=import-v2', '/static/today.js?v=today-v4', '/static/places.js?v=places-v1',
  '/static/timeline.js?v=presence-v1',
  '/static/map-config.js?v=map-marker-anchor-1', '/static/map-data.js?v=map-places-v1',
  '/static/map-view.js?v=map-places-v1', '/static/vendor/maplibre-gl/maplibre-gl.css',
